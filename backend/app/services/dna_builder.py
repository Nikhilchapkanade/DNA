...
def build_dna(metadata: dict) -> dict:
    ...
    genes = {
        "structural_conformation_gene": metadata.get("schema", []),
        "bio_pathway_lineage_gene": metadata.get("lineage", []),
        "target_usage_gene": metadata.get("usage", {}),
        "ownership_gene": {
